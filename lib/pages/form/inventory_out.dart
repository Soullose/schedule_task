...
///出库
class InventoryOutPage extends StatefulWidget {
  @override
  _InventoryOutPageState createState() => _InventoryOutPageState();
}

class _InventoryOutPageState extends State<InventoryOutPage>
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            FlatButton(
              child: Text("提交"),
              onPressed: enableButton ? () async {} : null,
